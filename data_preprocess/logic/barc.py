...
def get_datasets(cache_dir, N_samples=10000):
    ...
    """
    # Load the dataset
    ds = datasets.load_dataset("barc0/200k_HEAVY_gpt4o-description-gpt4omini-code_generated_problems", split="train", cache_dir=cache_dir)  # only have train split, no test split, max 200k samples
