...
class SGLangRollout(BaseRollout):
        ...
        while current_turns < self.config.multi_turn.max_turns:
            if _req.state == AsyncRolloutRequestStateEnum.PENDING:
                ...
                if _req.messages[-1].tool_calls is not None:
                    ...
                    for i, (tool_call, (resp, reward, route_to, arguments, metrics)) in enumerate(zip(parsed_tool_calls, tool_call_results)):
                        conversation_histories[-1]["route_to"] = route_to
                        conversation_histories[-1]["content"] = arguments
                        conversation_histories[-1]["feedback"] = resp
                ...
                conversation_histories[-1]["route_to"] = "self"
    ...
    def _req_level_generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        for req in sorted_output_req_list:
            ...
            turn_boundaries.append(turn_boundary_tensor)
        ...
        turn_boundaries = pad_sequence(turn_boundaries, batch_first=True, padding_value=0)
