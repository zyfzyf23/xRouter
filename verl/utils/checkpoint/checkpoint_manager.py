...
def get_best_score(root_path: str):
    best_score_file = get_best_score_tracker_filename(root_path)
...
def get_best_score_tracker_filename(root_path: str):
    return os.path.join(root_path, "best_score.txt")
